...
class Dash_PCA(dash.Dash):
    ...
    def plot_group_pca(self, projected_data, variance_explained, color_by):
    ...
    def plot_heatmap_pca(self, projected_data, variance_explained, color_by):
    ...
    def plot_pca(self, projected_data, variance_explained, color_by):
        ...
        if np.issubdtype(color_by.dtype, np.number):
            data = self.plot_heatmap_pca(projected_data, variance_explained, color_by)
        else:
            data = self.plot_group_pca(projected_data, variance_explained, color_by)
        layout = go.Layout(
                            title= 'PCA',
                            scene= {
